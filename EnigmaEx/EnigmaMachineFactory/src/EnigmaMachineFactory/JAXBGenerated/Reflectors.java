...
public class Reflectors {
    ...
    protected List<EnigmaMachineFactory.JAXBGenerated.Reflector> reflector;
     ...
     * {@link EnigmaMachineFactory.JAXBGenerated.Reflector }
     * 
     * 
     */
    public List<EnigmaMachineFactory.JAXBGenerated.Reflector> getReflector() {
        if (reflector == null) {
            reflector = new ArrayList<EnigmaMachineFactory.JAXBGenerated.Reflector>();
        }
